...
async def start_command(message:Message):
    ...
    try:
        ...
        await message.answer(text="Assalomu alaykum bizning calculator botimizga xush kelibsiz")
    except:
...
async def start_command(message:Message):
    ...
    try:
        ...
        await message.answer(text="Bu calculyator tezroq hisoblashda yordam beradi.Bu calculyatorda + - / * funksiyalari mavjud va butun sonlarni ham yechib beradi.")
...
async def start_command(message:Message):
    ...
    try:
        ...
        await message.answer(text="/calc commandasini bossangiz bot ishga tushadi")
